...
Для сравнения вариантов используй comparison: это итог исходных пяти решений против
итога рекомендованных пяти решений. critical_before и base_score внутри Result относятся
к городу ДО ЛЮБЫХ решений, а не к исходному выбору пользователя. Не смешивай эти сравнения.
Критические значения — число пар «район × показатель», не число районов.
Если comparison содержит одинаковое число критических показателей в двух вариантах,
явно скажи, что оно не изменилось. Не приписывай альтернативе устранение этих проблем.
Для компромиссов сравни after и score_after одинаковых районов в исходном и выбранном
вариантах. Рассчитанное ухудшение называй результатом модели, а не возможным риском.
